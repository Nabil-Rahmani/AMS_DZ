      ...
      child: Scaffold(
        ...
        bottomNavigationBar: Container(
          decoration: const BoxDecoration(
            color: DS.primary,
            border: Border(top: BorderSide(color: DS.primary)),
          ),
          child: Theme(
            ...
            child: NavigationBar(
              ...
              destinations: [
                ...
                const NavigationDestination(
                  icon:
                      Icon(Icons.person_outline_rounded, color: Colors.white60),
...
class _AuctionsHomeState extends State<_AuctionsHome>
        ...
        SliverAppBar(
          ...
          flexibleSpace: const FlexibleSpaceBar(
            background: Stack(children: [
              PurpleOrb(size: 260, alignment: Alignment.topLeft, opacity: 0.5),
              PurpleOrb(
                  size: 180, alignment: Alignment.bottomRight, opacity: 0.2),
              SafeArea(
                  child: Padding(
                ...
                child: FadeSlideIn(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: DS.purple.withValues(alpha: 0.3), width: 1.5),
                      boxShadow: [
                        BoxShadow(
    ...
    return StreamBuilder<Set<String>>(
      ...
      builder: (ctx, favSnap) {
        if (favSnap.connectionState == ConnectionState.waiting) {
          return const Center(
              child: CircularProgressIndicator(color: DS.error));
        }
