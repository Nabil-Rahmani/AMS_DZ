...
import 'package:auction_app2/features/admin/screens/admin_wallet_requests_screen.dart';
...
import 'package:auction_app2/features/notifications/notifications_screen.dart';
import 'package:auction_app2/features/wallet/wallet_screen.dart';
...
class AppRoutes {
  ...
  static const String adminWalletRequests = '/admin/wallet-requests';
  ...
  static const String myBids          = '/bidder/my-bids';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    // ── Admin ──
      ...
      case adminWalletRequests: return _route(const AdminWalletRequestsScreen());
    ...
    // ── Shared ──
      case wallet:        return _route(const WalletScreen());
      case notifications: return _route(const NotificationsScreen());
      case interests:     return _route(const InterestsScreen());
