        ...
        child: BackdropFilter(
          ...
          child: Container(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Row(children: [
                Expanded(child: _SourceBtn(icon: Icons.camera_alt_rounded, label: 'كاميرا', onTap: () => Navigator.pop(context, ImageSource.camera))),
                const SizedBox(width: 12),
                Expanded(child: _SourceBtn(icon: Icons.photo_library_rounded, label: 'المعرض', onTap: () => Navigator.pop(context, ImageSource.gallery))),
              ]),
            ]),
          ),
        ),
          ...
          slivers: [
            ...
            SliverAppBar(
              ...
              leading: widget.isRequired
                ...
                icon: Container(
                  width: 38, height: 38,
                  decoration: BoxDecoration(color: DS.bg.withValues(alpha: 0.5), shape: BoxShape.circle, border: Border.all(color: DS.border)),
              ...
              flexibleSpace: FlexibleSpaceBar(
                background: Stack(fit: StackFit.expand, children: [
                  ...
                  const Positioned(top: -50, right: -50, child: PurpleOrb(size: 280, opacity: 0.3)),
                    ...
                    child: FadeTransition(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.end, children: [
                        Container(
                          ...
                          decoration: BoxDecoration(color: DS.purple.withValues(alpha: 0.2), borderRadius: BorderRadius.circular(16), border: Border.all(color: DS.purple.withValues(alpha: 0.3))),
                          child: const Icon(Icons.badge_rounded, color: DS.purple, size: 28),
                        ),
              ...
              child: FadeTransition(
                ...
                child: Padding(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    // ── Banner ──
                    DSBanner(
                      message: 'لتتمكن من المزايدة، يرجى التقاط صورة واضحة لبطاقة هويتك (الوجه الأمامي والخلفي) للتأكد من هويتك كإجراء أمني.',
                      color: DS.purple,
                    ...
                    GlassCard(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Row(children: [
                          const Icon(Icons.tips_and_updates_rounded, color: DS.warning, size: 16),
                          const SizedBox(width: 8),
                          Text('نصائح للحصول على صورة واضحة', style: DS.label.copyWith(color: DS.warning)),
                        ]),
                        ...
                        ...[
                          ...
                          child: Row(children: [
                            Container(width: 5, height: 5, decoration: const BoxDecoration(color: DS.warning, shape: BoxShape.circle)),
                            const SizedBox(width: 8),
                            Expanded(child: Text(tip, style: DS.bodySmall)),
                          ]),
                        )),
                      ]),
                    ),
                    ...
                    FadeSlideIn(
                      ...
                      child: GradientButton(
                        label: _isLoading ? 'جاري الرفع...' : 'إرسال للتحقق',
...
class _IdCardUploadTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GlassCard(
      ...
      borderRadius: 20,
      backgroundColor: uploaded ? DS.success.withValues(alpha: 0.04) : DS.bgCard.withValues(alpha: 0.4),
      border: Border.all(color: uploaded ? DS.success.withValues(alpha: 0.4) : DS.border, width: uploaded ? 1.5 : 1),
          ...
          child: Row(children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: uploaded ? DS.success.withValues(alpha: 0.12) : DS.purple.withValues(alpha: 0.1),
                borderRadius: BorderRadius.circular(12),
              ),
              child: Icon(icon, color: uploaded ? DS.success : DS.purple, size: 22),
            ),
            const SizedBox(width: 14),
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(label, style: DS.titleS.copyWith(fontSize: 14)),
              const SizedBox(height: 3),
              Text(subtitle, style: DS.bodySmall.copyWith(color: DS.textMuted, fontSize: 12)),
            ])),
            if (uploaded)
              GestureDetector(
                onTap: onRemove,
                child: Container(
                  width: 36, height: 36,
                  decoration: BoxDecoration(color: DS.error.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(10)),
                  child: const Icon(Icons.delete_outline_rounded, color: DS.error, size: 18),
                ),
              ),
          ]),
        ),
        if (uploaded)
          ClipRRect(
            ...
            child: Stack(children: [
              ...
              Positioned.fill(child: Container(decoration: BoxDecoration(gradient: LinearGradient(colors: [Colors.transparent, DS.bg.withValues(alpha: 0.7)], begin: Alignment.topCenter, end: Alignment.bottomCenter)))),
              Positioned(bottom: 12, left: 12, right: 12,
                child: ClipRRect(borderRadius: BorderRadius.circular(10), child: BackdropFilter(filter: ImageFilter.blur(sigmaX: 8, sigmaY: 8),
                  child: Container(
                    ...
                    child: Row(children: [const Icon(Icons.check_circle_rounded, size: 14, color: DS.success), const SizedBox(width: 8), Text('تم اختيار الصورة', style: DS.label.copyWith(color: Colors.white, fontSize: 11))]),
                  ),
                )),
              ),
            ]),
          ...
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(color: DS.purple.withValues(alpha: 0.04), borderRadius: const BorderRadius.vertical(bottom: Radius.circular(20)), border: const Border(top: BorderSide(color: DS.border))),
              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                Container(padding: const EdgeInsets.all(8), decoration: BoxDecoration(color: DS.purple.withValues(alpha: 0.1), shape: BoxShape.circle), child: const Icon(Icons.add_photo_alternate_rounded, size: 22, color: DS.purple)),
                const SizedBox(height: 6),
                Text('اضغط لإضافة الصورة', style: DS.bodySmall.copyWith(color: DS.purple, fontWeight: FontWeight.w600)),
              ]),
            ),
          ),
      ]),
...
class _SourceBtn extends StatelessWidget {
  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(color: DS.purpleDeep, borderRadius: BorderRadius.circular(16), border: Border.all(color: DS.purple.withValues(alpha: 0.2))),
      child: Column(children: [
