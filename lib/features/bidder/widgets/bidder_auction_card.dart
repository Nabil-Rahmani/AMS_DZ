    ...
    return TapAnimated(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: isActive ? DS.primary.withValues(alpha: 0.2) : DS.border),
  ...
  Widget _statusBadge(AuctionStatus status, bool isActive) {
    switch (status) {
      case AuctionStatus.active:
        return const DarkBadge(label: '● LIVE', color: DS.primary, dot: false, pulse: false);
