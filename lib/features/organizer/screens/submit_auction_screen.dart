...
class _SubmitAuctionScreenState extends State<SubmitAuctionScreen>
  ...
  final List<String> _categories = [
    'عقارات', 'مركبات', 'إلكترونيات', 'أثاث', 'مجوهرات',
    'معدات صناعية', 'عتاد فلاحي', 'معدات طاقة',
    'معدات بناء وأشغال عمومية', 'أخرى',
  ];
  ...
  static const Map<String, List<Map<String, String>>> _categoryFields = {
    'مركبات': [
      {'key': 'vehicleType',    'label': 'نوع المركبة',     'hint': 'سيارة / شاحنة / دراجة / حافلة / جرار / ...', 'emoji': '🚗'},
      {'key': 'brand',          'label': 'الماركة',          'hint': 'مثال: Renault / Mercedes / Yamaha',           'emoji': '🏷'},
      {'key': 'model',          'label': 'الموديل',          'hint': 'مثال: Symbol / Actros / R1',                  'emoji': '🚘'},
      {'key': 'year',           'label': 'سنة الصنع',        'hint': 'مثال: 2019',                                  'emoji': '📅'},
      {'key': 'engine',         'label': 'المحرك',           'hint': 'مثال: 1.5L / 6 سلندر / 125cc',               'emoji': '⚙️'},
      {'key': 'fuel',           'label': 'الوقود',           'hint': 'بنزين / ديزل / غاز / كهرباء / هجين',         'emoji': '⛽'},
      {'key': 'mileage',        'label': 'المسافة (كم)',      'hint': 'مثال: 85000',                                'emoji': '📏'},
      {'key': 'transmission',   'label': 'ناقل الحركة',      'hint': 'أوتوماتيك / يدوي',                           'emoji': '🔄'},
      {'key': 'color',          'label': 'اللون',            'hint': 'مثال: رمادي معدني',                          'emoji': '🎨'},
      {'key': 'numPlate',       'label': 'رقم اللوحة',       'hint': 'اختياري',                                    'emoji': '🔢'},
      {'key': 'technicalVisit', 'label': 'الفحص التقني',     'hint': 'صالح حتى / منتهي',                           'emoji': '🔍'},
      {'key': 'condition',      'label': 'الحالة العامة',    'hint': 'ممتازة / جيدة / تحتاج صيانة',                'emoji': '✅'},
    ],
    'عقارات': [
      {'key': 'type',      'label': 'النوع',            'hint': 'شقة / فيلا / محل / أرض / مستودع / ...', 'emoji': '🏢'},
      {'key': 'area',      'label': 'المساحة (م²)',     'hint': 'مثال: 150',                              'emoji': '📐'},
      {'key': 'rooms',     'label': 'عدد الغرف',        'hint': 'مثال: 3',                                'emoji': '🛏'},
      {'key': 'bathrooms', 'label': 'عدد الحمامات',     'hint': 'مثال: 2',                                'emoji': '🚿'},
      {'key': 'floor',     'label': 'الطابق',           'hint': 'مثال: 2 / أرضي',                        'emoji': '🏗'},
      {'key': 'age',       'label': 'عمر البناء (سنة)', 'hint': 'مثال: 5',                                'emoji': '📅'},
      {'key': 'facing',    'label': 'الواجهة',          'hint': 'شمال / جنوب / شرق / غرب',               'emoji': '🧭'},
      {'key': 'condition', 'label': 'الحالة',           'hint': 'جديد / مجدد / يحتاج ترميم',              'emoji': '✅'},
    ],
    'إلكترونيات': [
      {'key': 'type',      'label': 'النوع',      'hint': 'لابتوب / هاتف / تلفاز / طابعة / ...', 'emoji': '🖥'},
      {'key': 'brand',     'label': 'الماركة',    'hint': 'مثال: Samsung / Apple / HP',          'emoji': '🏷'},
      {'key': 'model',     'label': 'الموديل',    'hint': 'مثال: Galaxy S23',                    'emoji': '📱'},
      {'key': 'ram',       'label': 'RAM (GB)',    'hint': 'مثال: 16',                            'emoji': '🧠'},
      {'key': 'storage',   'label': 'التخزين',    'hint': 'مثال: 512GB SSD',                     'emoji': '💾'},
      {'key': 'processor', 'label': 'المعالج',    'hint': 'مثال: i7 Gen 12',                     'emoji': '⚡'},
      {'key': 'screen',    'label': 'الشاشة',     'hint': 'مثال: 15.6 بوصة 4K',                 'emoji': '🖥'},
      {'key': 'battery',   'label': 'البطارية',   'hint': 'مثال: 5000 mAh / حالة جيدة',         'emoji': '🔋'},
      {'key': 'condition', 'label': 'الحالة',     'hint': 'جديد / مستعمل / يحتاج إصلاح',        'emoji': '✅'},
    ],
    'أثاث': [
      {'key': 'type',       'label': 'النوع',     'hint': 'غرفة نوم / صالون / مطبخ / مكتب / ...', 'emoji': '🪑'},
      {'key': 'material',   'label': 'المادة',    'hint': 'خشب طبيعي / MDF / معدن / قماش',        'emoji': '🪵'},
      {'key': 'color',      'label': 'اللون',     'hint': 'مثال: بني غامق / رمادي',               'emoji': '🎨'},
      {'key': 'dimensions', 'label': 'الأبعاد',   'hint': 'مثال: 200×90×75 سم',                   'emoji': '📐'},
      {'key': 'pieces',     'label': 'عدد القطع', 'hint': 'مثال: طقم 7 قطع',                      'emoji': '🔢'},
      {'key': 'condition',  'label': 'الحالة',    'hint': 'جديد / مستعمل / ممتاز',                'emoji': '✅'},
    ],
    'مجوهرات': [
      {'key': 'type',      'label': 'النوع',      'hint': 'خاتم / قلادة / سوار / حلق / طقم / ...', 'emoji': '💍'},
      {'key': 'material',  'label': 'المادة',     'hint': 'ذهب / فضة / بلاتين / ...',              'emoji': '✨'},
      {'key': 'weight',    'label': 'الوزن (غ)',  'hint': 'مثال: 12',                              'emoji': '⚖️'},
      {'key': 'carat',     'label': 'العيار',     'hint': 'مثال: 18 / 21 / 24',                    'emoji': '💎'},
      {'key': 'stones',    'label': 'الأحجار',    'hint': 'ألماس / ياقوت / زمرد / بدون',          'emoji': '💠'},
      {'key': 'origin',    'label': 'المصدر',     'hint': 'مثال: إيطالي / تركي / جزائري',         'emoji': '🌍'},
      {'key': 'condition', 'label': 'الحالة',     'hint': 'جديد / مستعمل',                         'emoji': '✅'},
    ],
    'معدات صناعية': [
      {'key': 'type',      'label': 'النوع',             'hint': 'كمبريسور / مولد / مخرطة / رافعة / ...', 'emoji': '🏭'},
      {'key': 'brand',     'label': 'الماركة',           'hint': 'مثال: Atlas Copco / Perkins',           'emoji': '🏷'},
      {'key': 'model',     'label': 'الموديل',           'hint': 'مثال: GA 15',                           'emoji': '🔖'},
      {'key': 'power',     'label': 'القدرة',            'hint': 'مثال: 15KW / 20HP',                     'emoji': '⚡'},
      {'key': 'year',      'label': 'سنة الصنع',         'hint': 'مثال: 2018',                            'emoji': '📅'},
      {'key': 'hours',     'label': 'ساعات العمل',       'hint': 'مثال: 3500 ساعة',                      'emoji': '⏱'},
      {'key': 'voltage',   'label': 'الجهد الكهربائي',   'hint': 'مثال: 380V / 220V',                    'emoji': '🔌'},
      {'key': 'condition', 'label': 'الحالة',            'hint': 'جيدة / تحتاج صيانة / ممتازة',          'emoji': '✅'},
    ],
    'عتاد فلاحي': [
      {'key': 'type',         'label': 'النوع',           'hint': 'جرار / حصادة / آلة بذر / مضخة / رشاش / ...', 'emoji': '🚜'},
      {'key': 'brand',        'label': 'الماركة',         'hint': 'مثال: John Deere / New Holland / Deutz',      'emoji': '🏷'},
      {'key': 'model',        'label': 'الموديل',         'hint': 'مثال: 5090R',                                 'emoji': '🔖'},
      {'key': 'year',         'label': 'سنة الصنع',       'hint': 'مثال: 2015',                                  'emoji': '📅'},
      {'key': 'power',        'label': 'القدرة (حصان)',   'hint': 'مثال: 90 CV',                                 'emoji': '⚡'},
      {'key': 'hours',        'label': 'ساعات العمل',     'hint': 'مثال: 2000 ساعة',                            'emoji': '⏱'},
      {'key': 'fuel',         'label': 'الوقود',          'hint': 'ديزل / بنزين',                               'emoji': '⛽'},
      {'key': 'transmission', 'label': 'ناقل الحركة',     'hint': 'يدوي / أوتوماتيك',                          'emoji': '🔄'},
      {'key': 'attachments',  'label': 'الملحقات',        'hint': 'محراث / ملقط / مقطورة / ...',               'emoji': '🔧'},
      {'key': 'condition',    'label': 'الحالة',          'hint': 'ممتازة / جيدة / تحتاج صيانة',               'emoji': '✅'},
    ],
    'معدات طاقة': [
      {'key': 'type',         'label': 'النوع',           'hint': 'ألواح شمسية / مولد / بطاريات / عاكس / ...', 'emoji': '⚡'},
      {'key': 'brand',        'label': 'الماركة',         'hint': 'مثال: Huawei / Victron / Fronius',          'emoji': '🏷'},
      {'key': 'model',        'label': 'الموديل',         'hint': 'مثال: SUN2000-10KTL',                       'emoji': '🔖'},
      {'key': 'power',        'label': 'القدرة (KW/Wc)',  'hint': 'مثال: 10KW / 400Wc',                        'emoji': '🔋'},
      {'key': 'quantity',     'label': 'الكمية',          'hint': 'مثال: 24 لوح / 8 بطاريات',                 'emoji': '🔢'},
      {'key': 'year',         'label': 'سنة الصنع',       'hint': 'مثال: 2022',                                'emoji': '📅'},
      {'key': 'voltage',      'label': 'الجهد',           'hint': 'مثال: 24V / 48V / 220V',                   'emoji': '🔌'},
      {'key': 'energySource', 'label': 'مصدر الطاقة',     'hint': 'شمسي / رياح / ديزل / هجين',               'emoji': '☀️'},
      {'key': 'warranty',     'label': 'الضمان',          'hint': 'مثال: 10 سنوات / منتهي',                   'emoji': '🛡'},
      {'key': 'condition',    'label': 'الحالة',          'hint': 'جديد / مستعمل / ممتاز',                    'emoji': '✅'},
    ],
    'معدات بناء وأشغال عمومية': [
      {'key': 'type',        'label': 'النوع',             'hint': 'حفارة / بلدوزر / رافعة / خلاطة / ...',     'emoji': '🏗'},
      {'key': 'brand',       'label': 'الماركة',           'hint': 'مثال: Caterpillar / Komatsu / JCB',         'emoji': '🏷'},
      {'key': 'model',       'label': 'الموديل',           'hint': 'مثال: CAT 320 / JCB 3CX',                  'emoji': '🔖'},
      {'key': 'year',        'label': 'سنة الصنع',         'hint': 'مثال: 2017',                                'emoji': '📅'},
      {'key': 'power',       'label': 'القدرة (CV/KW)',    'hint': 'مثال: 120CV / 90KW',                       'emoji': '⚡'},
      {'key': 'hours',       'label': 'ساعات العمل',       'hint': 'مثال: 5000 ساعة',                          'emoji': '⏱'},
      {'key': 'weight',      'label': 'الوزن (طن)',        'hint': 'مثال: 20 طن',                              'emoji': '⚖️'},
      {'key': 'reach',       'label': 'الامتداد / العمق',  'hint': 'مثال: 6م عمق / 15م ارتفاع',               'emoji': '📏'},
      {'key': 'fuel',        'label': 'الوقود',            'hint': 'ديزل / كهرباء',                            'emoji': '⛽'},
      {'key': 'attachments', 'label': 'الملحقات',          'hint': 'دلو / مطرقة / مجرفة / ...',                'emoji': '🔧'},
      {'key': 'condition',   'label': 'الحالة',            'hint': 'جيدة / ممتازة / تحتاج صيانة',             'emoji': '✅'},
    ],
  };
            ...
            child: ListView(
              ...
              children: [
                FadeSlideIn(
                  ...
                  child: DSBanner(
                    message: 'سيقوم المسؤول بتحديد يوم المعاينة وتاريخ المزاد بعد المراجعة.',
                    color: DS.info,
  ...
  IconData _getCategoryIcon(String category) {
    switch (category) {
      case 'مركبات':                    return Icons.directions_car_rounded;
      case 'عقارات':                    return Icons.home_rounded;
      case 'إلكترونيات':                return Icons.devices_rounded;
      case 'أثاث':                      return Icons.chair_rounded;
      case 'مجوهرات':                   return Icons.diamond_rounded;
      case 'معدات صناعية':             return Icons.precision_manufacturing_rounded;
      case 'عتاد فلاحي':               return Icons.agriculture_rounded;
      case 'معدات طاقة':               return Icons.bolt_rounded;
      case 'معدات بناء وأشغال عمومية': return Icons.construction_rounded;
