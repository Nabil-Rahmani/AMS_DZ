                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    'الوثائق المميزة بـ * إلزامية. سنقوم بمراجعة طلبك خلال 24 ساعة.',
                            ...
                            Row(
                              children: [
                                ...
                                const Spacer(),
                                Text(
                                  'التقدم: ${((_uploadedCount / _docs.length) * 100).toInt()}%',
                                  style: DS.label.copyWith(
                      ...
                      ..._docs.entries.toList().asMap().entries.map((entry) {
                        ...
                        return FadeSlideIn(
                          ...
                          child: _DocCard(
                            ...
                            onRemove: () =>
                                setState(() => _docs[e.key]!.file = null),
                          ),
                        );
                      }),
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Icon(
                    item.icon,
                    color: uploaded ? DS.success : DS.purple,
                    size: 24,
                  ),
                ),
                const SizedBox(width: 16),
