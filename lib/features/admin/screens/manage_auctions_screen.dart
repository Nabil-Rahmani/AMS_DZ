...
class _ManageAuctionsScreenState extends State<ManageAuctionsScreen>
  ...
  Future<void> _refundDeposits(AuctionModel auction) async {
    ...
    final losers =
        depositPaidBy.where((uid) => uid != auction.winnerId).toList();
        ...
        body: Column(children: [
                    ...
                    child: Row(children: [
                      ...
                      Column(
                          ...
                          children: [
                            ...
                            Text('مراجعة، موافقة وجدولة المزادات',
                                style: DS.bodySmall),
                          ]),
                    ]),
                  ),
          ...
          Expanded(
            child: TabBarView(
              controller: _tabController,
              children: _tabs
                  .map((t) => AdminAuctionList(
                        stream: _db.streamAuctions(
                            status: t['status'] as AuctionStatus?),
                        onApprove: _approve,
                        onReject: _reject,
...
class _RefundMethodDialog extends StatefulWidget {
  ...
  const _RefundMethodDialog(
      {required this.depositAmount, required this.losersCount});
  @override
                  ...
                  child: Column(children: [
                    ...
                    Row(
                        ...
                        children: [
                          ...
                          Text(
                              '- ${FirestoreService.subscriptionFee.toStringAsFixed(0)} DZD',
                ...
                if (_method == 'bank') ...[
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon:
                          const Icon(Icons.credit_card_rounded, color: DS.gold),
                      filled: true,
                      fillColor: DS.bgField,
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(12),
                  ...
                  Expanded(
                    ...
                    onPressed: () {
                      if (_method == 'bank' &&
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                              content: Text('أدخل رقم الحساب البنكي')),
                        );
                        return;
                      }
