      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide:   BorderSide(color: DS.purple, width: 2),
          ),
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: Stack(children: [
          const PurpleOrb(size: 300, alignment: Alignment.topRight, opacity: 0.4),
          SafeArea(
            child: Padding(
              ...
              child: Column(children: [
                ...
                AnimatedBuilder(
                  ...
                  builder: (_, __) => Transform.scale(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        color: DS.purple.withValues(alpha: 0.1 + _pulse.value * 0.05),
                        border: Border.all(
                          color: DS.purple.withValues(alpha: 0.3 + _pulse.value * 0.2),
                          width: 2,
                        ),
                        boxShadow: [BoxShadow(
                          color:      DS.purple.withValues(alpha: 0.15 + _pulse.value * 0.1),
                ...
                FadeSlideIn(
                  ...
                  child: Container(
                    ...
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      const Icon(Icons.mail_rounded, color: DS.purple, size: 18),
                      const SizedBox(width: 10),
                      Text(emailName,   style: DS.titleS.copyWith(color: DS.purple)),
                      Text(emailDomain, style: DS.body.copyWith(color: DS.textSecondary)),
                    ]),
                  ),
                ),
                ...
                FadeSlideIn(
                  ...
                  child: Text(
                    ...
                    style:     DS.body.copyWith(color: DS.textSecondary, height: 1.6),
                    textAlign: TextAlign.center,
                  ),
                ),
                    ...
                    child: AnimatedContainer(
                      ...
                      child: Center(
                        child: _resending
                          ...
                          Text('إعادة الإرسال بعد ${_resendTimer}ث',
                              style: DS.label.copyWith(color: DS.textMuted)),
                        ])
                            : Row(mainAxisSize: MainAxisSize.min, children: [
