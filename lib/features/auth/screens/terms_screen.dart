              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Center(
                  child: Column(children: [
                    ...
                    Text('يرجى قراءة والموافقة على شروط الاستخدام وسياسة الخصوصية للمتابعة',
                        style: DS.bodySmall, textAlign: TextAlign.center),
                  ]),
                ),
                ...
                child: Row(children: [
                  AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: _accepted ? DS.purple : DS.border, width: 1.5),
                    ),
                    child: _accepted
                  ...
                  Expanded(child: Text('أوافق على الشروط وسياسة الخصوصية', style: DS.body)),
                ]),
              ),
              const SizedBox(height: 16),
              GradientButton(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        ...items.map((item) => Padding(
          ...
          child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Expanded(child: Text(item, style: DS.body.copyWith(height: 1.5))),
          ]),
        )),
      ]),
    );
